// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.9.2.
  ...
  F = {
    main: function() {
      var t1 = J.get$onClick$x(document.querySelector("#button")),
        t2 = t1.$ti;
      t2._eval$1("~(1)?")._as(F.main__getSum$closure());
      type$.nullable_void_Function._as(null);
      W._EventStreamSubscription$(t1._target, t1._eventType, F.main__getSum$closure(), false, t2._precomputed1);
    },
    getSum: function($event) {
      var t1, t2, num1, num2, sum;
      type$.legacy_MouseEvent._as($event);
      t1 = document;
      t2 = type$.legacy_InputElement;
      num1 = P.int_parse(t2._as(t1.querySelector("#num1")).value);
      num2 = P.int_parse(t2._as(t1.querySelector("#num2")).value);
      if (typeof num1 !== "number")
        return num1.$add();
      if (typeof num2 !== "number")
        return H.iae(num2);
      sum = C.JSInt_methods.toString$0(num1 + num2);
      J.set$text$x(t1.querySelector("#sum"), "" + num1 + " + " + num2 + " = " + sum);
    }
  };
